...
// victimsCmd represents the victims command
...
func init() {
	...
	// victimsCmd.PersistentFlags().String("foo", "", "A help for foo")

	// Cobra supports local flags which will only run when this command
	// is called directly, e.g.:
	// victimsCmd.Flags().BoolP("toggle", "t", false, "Help message for toggle")
}
